...
import com.wipro.security.jwt.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public  SecurityFilterChain   getSecurityFilterChain(HttpSecurity http) throws Exception {
    		...
    		return http.csrf().disable()
    			.authorizeHttpRequests().requestMatchers("/api/vehicles/welcome","/users/registration/new","/users/login/authenticate")
    			.permitAll()
    			.and()
    			.authorizeHttpRequests().requestMatchers("/api/vehicles/**")
